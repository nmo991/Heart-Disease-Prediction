...
model_data = joblib.load('./1500 patients xgboost/heart_model.pkl')
...
# Prepare data using ONLY the features the model knows
X = df[features]
y = df['heart_disease']
...
y_proba = model.predict_proba(X_scaled)[:, 1]  # probability of heart disease
